...
/* SettingsBundle:Default:manageStages.html.twig */
class __TwigTemplate_fbd8dac2a978cd76103ee178bf2ce034fa77eba064c75cd62a2fd85d7d513180 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t<tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["stage"]) {
            echo " 
                                                                                 ";
            // line 60
            if (((($this->getAttribute($context["stage"], "getStatus", array(), "method") == "Inactive") && ($this->getAttribute($context["stage"], "getUsername", array(), "method") == (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")))) || ($this->getAttribute($context["stage"], "getStatus", array(), "method") == "Active"))) {
                echo "                             
                                                                                    <tr>
                                                                                     
\t\t\t\t\t\t\t\t\t\t\t<td>";
                // line 63
                echo twig_escape_filter($this->env, $this->getAttribute($context["stage"], "getName", array(), "method"), "html", null, true);
                echo "</td>
                                                                                        <td>";
                // line 64
                echo twig_escape_filter($this->env, $this->getAttribute($context["stage"], "getSalechance", array(), "method"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                // line 65
                echo twig_escape_filter($this->env, $this->getAttribute($context["stage"], "getNotes", array(), "method"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t\t\t\t
                                                                                        ";
                // line 67
                if (((isset($context["role"]) ? $context["role"] : $this->getContext($context, "role")) == "Admin")) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("settings_editstage", array("id" => $this->getAttribute($context["stage"], "getId", array(), "method"))), "html", null, true);
                    echo "\"><i class=\"fa fa-pencil\"></i></a>";
                    if (($this->getAttribute($context["stage"], "getStatus", array()) == "Inactive")) {
                        echo "<a href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("settings_activatestage", array("id" => $this->getAttribute($context["stage"], "getId", array(), "method"))), "html", null, true);
                        echo "\"> Activate</a>";
                    }
                    echo "</td>
                                                                                        ";
...
\t\t\t\t}
        ...
        // line 229
        echo $this->env->getExtension('routing')->getPath("settings_addstage");
...
";
    ...
    {
        return "SettingsBundle:Default:manageStages.html.twig";
    }
    ...
    {
        return array (  407 => 229,  329 => 153,  325 => 152,  309 => 139,  305 => 138,  301 => 137,  297 => 136,  292 => 134,  288 => 133,  284 => 132,  280 => 131,  276 => 130,  272 => 129,  268 => 128,  264 => 127,  260 => 126,  256 => 125,  252 => 124,  248 => 123,  244 => 122,  240 => 121,  236 => 120,  232 => 119,  228 => 118,  224 => 117,  220 => 116,  216 => 115,  212 => 114,  204 => 109,  199 => 107,  185 => 96,  173 => 86,  171 => 85,  157 => 73,  150 => 72,  145 => 70,  133 => 68,  131 => 67,  126 => 65,  122 => 64,  118 => 63,  112 => 60,  106 => 59,  99 => 54,  93 => 52,  75 => 36,  68 => 32,  62 => 28,  59 => 27,  52 => 23,  46 => 19,  44 => 18,  35 => 11,  33 => 10,  25 => 4,  23 => 3,  19 => 1,);
    }
}
