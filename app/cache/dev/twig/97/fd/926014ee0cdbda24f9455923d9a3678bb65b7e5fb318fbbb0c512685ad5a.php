...
/* ContactsContactsBundle:Default:importContacts.html.twig */
class __TwigTemplate_97fd926014ee0cdbda24f9455923d9a3678bb65b7e5fb318fbbb0c512685ad5a extends Twig_Template
{
...
\t\t\t\t\t\t\t";
        ...
        // line 35
        echo "                                                         <div class=\"alert alert-success alert-dismissable\" id=\"successmsg\" style=\"display: none\">
                                                            <button type=\"button\" class=\"close bigger-200\" data-dismiss=\"alert\" aria-hidden=\"true\">
                                                                            &times;
                                                            </button>
                                                             <center> <strong> Well done! Your contacts have been sucessfully imported</strong></center>
                                                        </div>
             
                                        
                                        
             
                                            <div class=\"alert alert-danger alert-dismissible\" id=\"errormsg\" style=\"display: none\">
                                                <button type=\"button\" class=\"close bigger-200\" data-dismiss=\"alert\" aria-hidden=\"true\">
                                                                            &times;
                                                </button>
                                                <center> <strong> Your import have some duplicates.Unique contacts succesfully imported</strong></center>
...
\t\t\t\t\t\t\t<div class=\"col-xs-12\">
\t\t\t\t\t\t\t\t<!-- PAGE CONTENT BEGINS -->
\t\t\t\t\t\t\t\t<h3 class=\"header smaller lighter blue\">Import Contacts</h3>
...
\t\t\t\t\t\t\t\t\t<h4 class=\"widget-title\">Import Contacts from CSV File</h4>
...
";
    ...
    {
        return "ContactsContactsBundle:Default:importContacts.html.twig";
    }
