...
/* SettingsBundle:Default:editAccountType.html.twig */
class __TwigTemplate_2c0b155c7e032144747f28563da2b5b8290dab56a6ccbda1fc8d0a65c7221b1f extends Twig_Template
{
...
\t\t\t\t\t\t\t<div class=\"col-xs-12\">
\t\t\t\t\t\t\t\t<!-- PAGE CONTENT BEGINS -->
                                                                <h3 class=\"header smaller lighter blue\">Edit Account Type</h3>
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"firstname\"> Account Type<span style=\"color:#FF0000;\">*</span>  </label>
                                                                            <div class=\"input-group col-sm-4\">
                                                                                <input type=\"text\" name=\"name\" id=\"name\" value = \"";
        // line 53
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accounttype"]) ? $context["accounttype"] : $this->getContext($context, "accounttype")), "getName", array(), "method"), "html", null, true);
        echo "\" placeholder=\"Account Type\" class=\"col-sm-12\" onkeyup=\"accounttypeAvailability()\"  pattern=\"^[a-zA-Z0-9()_,.'/\\-& ]*\$\" data-parsley-pattern=\"^[a-zA-Z0-9()_,.'/\\-& ]*\$\"  data-parsley-trigger=\"keyup\" required/>
...
\t\t\t\t\t\t\t\t\t\t<textarea  id=\"notes\" placeholder=\"Notes\" class=\"col-sm-12\" style=\"height:100px\" name=\"notes\" data-parsley-pattern=\"^[a-zA-Z0-9(),.:/;'_&\\n ]*\$\" data-parsley-trigger=\"keyup\">";
        // line 63
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accounttype"]) ? $context["accounttype"] : $this->getContext($context, "accounttype")), "getNotes", array(), "method"), "html", null, true);
        echo "</textarea>
                                                                            </div>    
                                                                        </div>
                                                                        <input type=\"hidden\" value = \"";
        // line 66
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accounttype"]) ? $context["accounttype"] : $this->getContext($context, "accounttype")), "getId", array(), "method"), "html", null, true);
        echo "\" name =\"id\">
                                                                       </div>
...
\t\t\t\t\t\t\t\t\t\t\t&nbsp; 
                                                                                         <a href=\"";
        // line 77
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("settings_deleteaccounttype", array("id" => $this->getAttribute((isset($context["accounttype"]) ? $context["accounttype"] : $this->getContext($context, "accounttype")), "getId", array(), "method"))), "html", null, true);
                ...
                {name: document.getElementById('name').value}, 
                    function(response){
                        if(response == \"true\"){
                            ...
                            document.getElementById('nameerror').innerHTML = \"<font color = '#B94A48'>account type already exists.</font>\";
                        }else{
...
";
    ...
    {
        return "SettingsBundle:Default:editAccountType.html.twig";
    }
