...
/* LoginLoginBundle:Default:addUsers.html.twig */
class __TwigTemplate_9594a374448ca63e64dd1b77e823e9ec086c38206828540d001390cbb4af2048 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"firstname\"> First Name<span style=\"color:#FF0000;\">*</span>  </label>
                                                                            <div class=\"input-group col-sm-4\">
                                                                                <input type=\"text\" name=\"firstname\" id=\"firstname\" placeholder=\"First Name\" class=\"col-sm-12\"  pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" required/>
                                                                            </div>    
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"lastname\"> Last Name<span style=\"color:#FF0000;\">*</span>  </label>
                                                                            <div class=\"input-group col-sm-4\">
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"lastname\" name=\"lastname\" placeholder=\"Last Name\" class=\"col-sm-12\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" required />
                                                                             </div>    
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t    <div class=\"input-group col-sm-4\">
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"username\" id=\"username\" placeholder=\"Username\" class=\"col-sm-12\" onkeyup=\"usernameAvailability()\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z0-9_ ]*\$\"  data-parsley-trigger=\"keyup\" required />
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"email\"> Email<span style=\"color:#FF0000;\">*</span> </label>
                                                                            <div class=\"input-group col-sm-4\">    
\t\t\t\t\t\t\t\t\t\t<input type=\"email\" id=\"email\" placeholder=\"Email\" class=\"col-sm-12\" name=\"email\"  data-parsley-type=\"email\" data-parsley-trigger=\"keyup\"  required />
\t\t\t\t\t\t\t\t\t    </div>\t
\t\t\t\t\t\t\t\t\t</div>  
...
\t\t\t\t\t\t\t\t\t\t<input type=\"tel\" id=\"officetel\" name=\"officetel\" placeholder=\"( _ _ _ ) _ _ _ - _ _ _ _ Ext._ _ _ _\" class=\"col-sm-4\"  data-parsley-trigger=\"change\" onkeydown=\"return tel_check(event)\" onkeypress=\"return false;\" required />
                                                                                  
                                                                               
                                                                                <label class=\"col-sm-2 control-label no-padding-left\" for=\"mobile\"> Telephone - Mobile  </label>
                                                                               
\t\t\t\t\t\t\t\t\t\t<input type=\"tel\" id=\"mobile\" name=\"mobile\" data-parsley-trigger=\"change\"  onkeydown=\"return mob_check(event)\" onkeypress=\"return false;\" placeholder=\"( _ _ _ ) _ _ _ - _ _ _ _ \" class=\"col-sm-4\" />
                                                                            </div> 
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"jobtitle\"> Job Title  </label>
                                                                            <div class=\"input-group col-sm-4\">    
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"jobtitle\" placeholder=\"Job Title\" class=\"col-sm-12\" name=\"jobtitle\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" />
                                                                            </div>    
\t\t\t\t\t\t\t\t\t</div>  
                                                                        <div class=\"form-group\" >
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"companyName\"> Company Name  </label>
                                                                            <div class=\"input-group col-sm-4\">    
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"companyName\" placeholder=\"Company Name\" class=\"col-sm-12\" name=\"companyname\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\"/>
                                                                            </div>    
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"address1\"> Address 1  </label>
                                                                            <div class=\"input-group col-sm-4\">    
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"address1\" placeholder=\"Address 1\" class=\"col-sm-12\" name=\"address1\" pattern=\"^[a-zA-Z0-9_,./\\ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" />
                                                                            </div>    
\t\t\t\t\t\t\t\t\t</div>  
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"address2\"> Address 2  </label>
                                                                            <div class=\"input-group col-sm-4\">     
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"address2\" placeholder=\"Address 2\" class=\"col-sm-12\" name=\"address2\" pattern=\"^[a-zA-Z0-9,._/\\ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" />
\t\t\t\t\t\t\t\t\t    </div>\t
\t\t\t\t\t\t\t\t\t</div> 
                                                                        <div class=\"form-inline form-group\" > 
                                                                            ...
                                                                            <div class=\"input-group col-sm-12\">
                                                                                ...
                                                                                <div class=\"input-group col-sm-3 pull-left\">    
                                                                                    <input type=\"text\" id=\"city\" placeholder=\"City\" class=\"col-sm-12\" name=\"city\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\"  data-parsley-trigger=\"keyup\" />
...
\t\t\t\t\t\t\t\t\t</div> 
                                                                        <div class=\"form-inline form-group\" >
                                                                            <div class=\"input-group col-sm-12\">
                                                                                ...
                                                                                <input class=\" col-sm-3 date-picker\" id=\"dob\" type=\"text\" name=\"dob\" data-date-format=\"mm-dd-yyyy\" placeholder=\"mm-dd-yyyy\" />
                                                                                 
                                                                                
                                                                                <label class=\"col-sm-3 control-label no-padding-left\" for=\"empstartdate\"> Employment Start Date  </label>
                                                                                <input class=\"date-picker  col-sm-3\" id=\"empstartdate\" name=\"empstartdate\" type=\"text\" data-date-format=\"mm-dd-yyyy\" placeholder=\"mm-dd-yyyy\" />
                                                                            </div>
                                                                        </div>  
                                                                        <div class=\"form-inline form-group\" > 
                                                                            <div class=\"input-group col-sm-12\">  
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\"  for=\"commisionoriginator\">Commission Origin<span style=\"color:#FF0000;\">*</span> </label>
                                                                                ...
                                                                                <input type=\"text\" id=\"commisionoriginator\" name=\"commisionoriginator\" data-parsley-type=\"digits\" data-parsley-trigger=\"keyup\" class=\"col-sm-12\" required/>
...
\t\t\t\t\t\t\t\t\t\t</span>
                                                                                ...
                                                                                <input type=\"text\" id=\"commisionnonoriginator\" name=\"commisionnonoriginator\"  data-parsley-type=\"digits\" data-parsley-trigger=\"keyup\" class=\"col-sm-12\"  required/>
                                                                                <span class=\"input-group-addon\">
\t\t\t\t\t\t\t\t\t\t%
\t\t\t\t\t\t\t\t\t\t</span>  
                                                                                </div>
...
\t\t\t\t\t\t\t\t\t\t\$
\t\t\t\t\t\t\t\t\t\t</span>
                                                                                <input type=\"text\" name=\"earninggoals\" id=\"earninggoals\" onkeydown=\"return currency_format1(event,'earninggoals')\" class=\"col-sm-12\" required />
                                                                                </div>
...
\t\t\t\t\t\t\t\t\t\t\$
\t\t\t\t\t\t\t\t\t\t</span>    
                                                                                <input type=\"text\" name=\"annualdraw\" id=\"annualdraw\" onkeydown=\"return currency_format(event,'annualdraw')\" class=\"col-sm-12\" />
                                                                                </div>
                                                                            </div>    
\t\t\t\t\t\t\t\t\t</div> 
                                                                        <div class=\"form-group\">
\t\t\t\t\t\t\t\t\t\t<label for=\"notes\" class=\"col-sm-2 control-label no-padding-left\">Notes</label>
                                                                            <div class=\"input-group col-sm-4\">      
\t\t\t\t\t\t\t\t\t\t<textarea  id=\"notes\" placeholder=\"Notes\" class=\"col-sm-12\" name=\"profilenote\" data-parsley-pattern=\"^[a-zA-Z0-9,.:;'_ ]*\$\" data-parsley-trigger=\"keyup\"></textarea>
                                                                            </div>    
                                                                        </div>
                                                                        <div class=\"form-inline form-group\" > 
                                                                            <div class=\"input-group col-sm-12\">
...
\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label no-padding-left\" for=\"linkedin\"> LinkedIn  </label>
                                                                                <div class=\"input-group col-sm-3 pull-left\"> 
\t\t\t\t\t\t\t\t\t\t
                                                                                    <input type=\"text\" id=\"linkedin\" placeholder=\"LinkedIn\" class=\"col-sm-12 no-padding-right\" name=\"linkedin\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-trigger=\"keyup\" />
...
\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"twitter\" placeholder=\"Twitter\" class=\"col-sm-12\" name=\"twitter\" pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-pattern=\"^[a-zA-Z_ ]*\$\" data-parsley-trigger=\"keyup\" />
...
";
    ...
    {
        return "LoginLoginBundle:Default:addUsers.html.twig";
    }
    ...
    {
        return array (  1139 => 960,  1135 => 959,  1131 => 958,  1127 => 957,  1123 => 956,  1119 => 955,  1115 => 954,  1111 => 953,  1107 => 952,  1103 => 951,  1099 => 950,  1095 => 949,  1091 => 948,  1087 => 947,  1083 => 946,  1079 => 945,  1075 => 944,  1071 => 943,  1067 => 942,  1063 => 941,  1059 => 940,  1053 => 937,  1049 => 936,  1045 => 935,  1041 => 934,  1037 => 933,  1033 => 932,  1029 => 931,  1025 => 930,  1021 => 929,  1017 => 928,  1013 => 927,  1009 => 926,  1005 => 925,  1001 => 924,  997 => 923,  991 => 920,  986 => 918,  982 => 917,  978 => 916,  974 => 915,  758 => 702,  737 => 684,  333 => 283,  319 => 272,  307 => 262,  305 => 261,  88 => 47,  76 => 37,  69 => 33,  63 => 29,  60 => 28,  53 => 24,  47 => 20,  45 => 19,  35 => 11,  33 => 10,  25 => 4,  23 => 3,  19 => 1,);
    }
}
