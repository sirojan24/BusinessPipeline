...
/* SettingsBundle:Default:manageProductTypes.html.twig */
class __TwigTemplate_aaa5d6c4d2f2d235c71b185886b7fcca8f46e98e63e55070217a1f0eb7f9917d extends Twig_Template
{
...
\t\t\t\t\t\t\t<div class=\"col-xs-12\">
\t\t\t\t\t\t\t\t<!-- PAGE CONTENT BEGINS -->
\t\t\t\t\t\t\t\t<h3 class=\"header smaller lighter blue\">Manage Product Types</h3>
...
\t\t\t\t\t\t\t\t\t<tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["producttype"]) {
            echo " 
                                                                                 ";
            // line 60
            if (((($this->getAttribute($context["producttype"], "getStatus", array(), "method") == "Inactive") && ($this->getAttribute($context["producttype"], "getUsername", array(), "method") == (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")))) || ($this->getAttribute($context["producttype"], "getStatus", array(), "method") == "Active"))) {
                echo "                             
                                                                                    <tr>
                                                                                     
\t\t\t\t\t\t\t\t\t\t\t<td>";
                // line 63
                echo twig_escape_filter($this->env, $this->getAttribute($context["producttype"], "getName", array(), "method"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                // line 64
                echo twig_escape_filter($this->env, $this->getAttribute($context["producttype"], "getNotes", array(), "method"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t\t\t\t
                                                                                        ";
                // line 66
                if (((isset($context["role"]) ? $context["role"] : $this->getContext($context, "role")) == "Admin")) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("settings_editproducttype", array("id" => $this->getAttribute($context["producttype"], "getId", array(), "method"))), "html", null, true);
                    echo "\"><i class=\"fa fa-pencil\"></i></a>";
                    if (($this->getAttribute($context["producttype"], "getStatus", array()) == "Inactive")) {
                        echo "<a href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("settings_activateproducttype", array("id" => $this->getAttribute($context["producttype"], "getId", array(), "method"))), "html", null, true);
                        echo "\"> Activate</a>";
                    }
                    echo "</td>
                                                                                        ";
...
\t\t\t\t}
        ...
        // line 228
        echo $this->env->getExtension('routing')->getPath("settings_addproducttype");
...
";
    ...
    {
        return "SettingsBundle:Default:manageProductTypes.html.twig";
    }
