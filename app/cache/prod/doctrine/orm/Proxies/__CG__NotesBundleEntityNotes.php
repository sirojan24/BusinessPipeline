...
namespace Proxies\__CG__\NotesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Notes extends \NotesBundle\Entity\Notes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'name', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'priority', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'due', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'visibility', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'notes', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'tags', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'type', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'typeid', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'username', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'timestamp', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'id', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'status', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'companyname', '' . "\0" . 'NotesBundle\\Entity\\Notes' . "\0" . 'fullname');
        }
